  ...
  const data = [
    {
      id: 1,
      name: 'check1',
      text: 'I have tested my token with the TKREV app on a test network.(Ex Ropsten or BSC testnet)',
    },
    { id: 2, name: 'check2', text: 'My token has a function to disable special transfers or has no special transfers' },
    {
      id: 3,
      name: 'check3',
      text: 'My token is not already listed on the target DEX and I have not given out any tokens to users',
    },
    {
      id: 4,
      name: 'check4',
      text: 'I understand that TKREV is not responsible for any issues or loss of funds caused due to errors or exploits of code.',
    },
    { id: 5, name: 'check5', text: 'I understand fees paid to launch a SALE are non-recoverable' },
    {
      id: 6,
      name: 'check6',
      text: 'I understand that I have to finalize my sale within 48 hours of hitting the hardcap!',
    },
    {
      id: 7,
      name: 'check7',
      text: 'I am using TKREV as a software tool only and am responsible for anything I create on it',
    },
    {
      id: 8,
      name: 'check8',
      text: 'I understand that I am responsible for following my local laws and regulations including KYC and AML practices.',
    },
    ...
    <div>
      ...
      <GridContainer>
        ...
        <GridItem xs={12} sm={12} md={2}>
          <FormControlLabel
            color="warning"
            control={<Checkbox {...label} onChange={checkAll} icon={<FavoriteBorder />} checkedIcon={<Favorite />} />}
            label={'Agree all'}
          />
        </GridItem>
