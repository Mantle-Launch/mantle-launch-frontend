...
import ConnectWalletPage from "./components/CoinSwapper/connectWalletPage";
import {
  getAccount,
  getFactory,
  getRouter,
...
import COINS from "./components/CoinSwapper/Constants/coins";
import * as chains from "./components/CoinSwapper/Constants/chains";
  ...
  async function setupConnection() {
    try {
      ...
      await getNetwork(network.provider).then(async (chainId) => {
        ...
        console.log("chains", chains.networks)
